...
import { createReceitas } from "../../mutations";
const client = generateClient();
export default function ReceitasCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createReceitas.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ReceitasCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
