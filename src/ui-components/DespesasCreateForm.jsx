...
import { createDespesas } from "../../mutations";
const client = generateClient();
export default function DespesasCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDespesas.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DespesasCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
